    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleMatch", x => new { x.ArticlesId, x.MatchesId });
                    table.ForeignKey(
                        name: "FK_ArticleMatch_Articles_ArticlesId",
                        column: x => x.ArticlesId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleMatch_Matches_MatchesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleMatch_MatchesId",
                table: "ArticleMatch",
                column: "MatchesId");
