    ...
    public class RegisterNewUsersDataModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            ViewData["Roles"] = new SelectList(
                _dbContext.Roles.Select(t => new { Text = t.Name, Value = t.Id }),
                "Value",
                "Text",
                parent?.Id
            );
            ViewData["Groups"] = new SelectList(
                _dbContext.Groups.Select(t => new { Text = t.Name, Value = t.Id }),
                "Value",
                "Text"
            );
            ViewData["Parents"] = new SelectList(
                _dbContext
                    .Users.OfType<Parent>()
                    .Select(t => new { Text = $"{t.FirstName} {t.LastName}", Value = t.Id }),
                "Value",
                "Text"
            );
            return Page();
