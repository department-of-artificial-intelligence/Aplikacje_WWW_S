...
namespace Web.Controllers
{
    public class RoomController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var viewModels = _mapper.Map<List<RoomListItemViewModel>>(dtos);
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var viewModel = _mapper.Map<RoomDetailsViewModel>(dto);
        ...
        public async Task<IActionResult> Create(CreateRoomViewModel model)
        {
            ...
            SetSuccessMessage("Sala zosta³a utworzona.");
        ...
        public async Task<IActionResult> Edit(EditRoomViewModel model)
        {
            ...
            if (success)
            {
                SetSuccessMessage("Sala zosta³a zaktualizowana.");
                return RedirectToAction(nameof(Index));
            }

            SetErrorMessage("Wyst¹pi³ b³¹d podczas aktualizacji sali.");
            model.Buildings = await CreateBuildingSelectListAsync(model.BuildingId);
            return View(model);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (success) SetSuccessMessage("Sala zosta³a usuniêta.");
            else SetErrorMessage("Nie uda³o siê usun¹æ sali.");
