    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BibliotekiId = table.Column<int>(type: "int", nullable: false),
                    KsiazkiId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BibliotekaKsiazka", x => new { x.BibliotekiId, x.KsiazkiId });
                    table.ForeignKey(
                        name: "FK_BibliotekaKsiazka_Biblioteki_BibliotekiId",
                        column: x => x.BibliotekiId,
                        principalTable: "Biblioteki",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BibliotekaKsiazka_Ksiazki_KsiazkiId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BibliotekaKsiazka_KsiazkiId",
