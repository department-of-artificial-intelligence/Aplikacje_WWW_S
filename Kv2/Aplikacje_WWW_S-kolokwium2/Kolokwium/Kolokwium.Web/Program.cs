using Kolokwium.Services.Mapping;
...
builder.Services.AddAutoMapper(typeof(MainProfile), typeof(PersonProfile), typeof(WebMappingProfile));
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"))
    .UseLazyLoadingProxies()//here you can define a database type.
);
