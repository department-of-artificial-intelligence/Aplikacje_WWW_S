...
public class GroupServiceUnitTests : BaseUnitTests
{
    ...
    public GroupServiceUnitTests(AppDbContext dbContext, IGroupService groupService)
        : base(dbContext)
    {
    ...
    {
        var addOrUpdateGroupVm = new AddOrUpdateGroupVm { Name = "SK" };
    ...
    {
        var addOrUpdateGroupVm = new AddOrUpdateGroupVm { Name = "SIiDM", Id = 3 };
        _groupService.AddOrUpdateGroup(addOrUpdateGroupVm);
    ...
    {
        var attachSubjectGroupVm = new AttachDetachSubjectGroupVm() { GroupId = 1, SubjectId = 4 };
        ...
        Assert.NotNull(group);
        Assert.NotNull(
            group.Subjects.FirstOrDefault(s =>
                s.Name == "Administracja Intenetowymi Systemami Baz Danych"
            )
        );
    }
    ...
    {
        var detachSubjectGroupVm = new AttachDetachSubjectGroupVm() { GroupId = 1, SubjectId = 4 };
