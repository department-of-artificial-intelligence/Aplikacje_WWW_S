...
[Fact]
public async Task AttachStudentToGroup()
{
...
var student = await _groupService.AttachStudentToGroup(attachStudentToGroupVm);
...
[Fact]
public async Task DetachStudentFromGroup()
{
var attachStudentToGroupVm = new AttachDetachStudentToGroupVm()
    {
        GroupId = 1,
    ...
    await _groupService.AttachStudentToGroup(attachStudentToGroupVm); // <- ważne
...
var student = await _groupService.DetachStudentFromGroup(detachStudentToGroupVm);
...
[Fact]
public async Task AttachTeacherToSubject()
{
...
var subject = await _groupService.AttachTeacherToSubject(attachSubjectTeacher);
